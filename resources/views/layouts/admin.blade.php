    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="{{url('test1/weather')}}">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('test/add')}}">商品添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('test/show')}}">商品展示</a>
                        </li>
                ...
                <li class="line dk"></li>
                <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                    <span class="ng-scope">后台管理模块</span>
                </li>
                <li>
                    <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">后台管理模块 </span></a>
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="{{url('admin1/cate/add')}}">商品分类添加</a>
                        </li>
                        <li><a class="J_menuItem" href="{{url('admin1/cate/show')}}">商品分类展示</a>
                        </li>
                        <li><a class="J_menuItem" href="{{url('admin1/type/add')}}">商品类型添加</a>
                        <li><a class="J_menuItem" href="{{url('admin1/type/show')}}">商品类型展示</a>
                        <li><a class="J_menuItem" href="{{url('admin1/attr/add')}}">商品属性添加</a>
                        </li>
                        <li><a class="J_menuItem" href="{{url('admin1/attr/show')}}">商品属性展示</a>
                        </li>
                        <li><a class="J_menuItem" href="{{url('admin1/goods/add')}}">商品添加</a>
                        </li>
                        <li><a class="J_menuItem" href="{{url('admin1/goods/show')}}">货品展示</a>
                        </li>
                        <li>
...
{{--        </div>--}}
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="{{url('test1/weather')}}" frameborder="0" data-id="" seamless></iframe>
        </div>
